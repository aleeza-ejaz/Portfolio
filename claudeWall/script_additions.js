...
const carouselSlides = {
  ...
  resourcecentral: [
    { bg: 'linear-gradient(135deg,#2a0e00,#7a2e00)', label: 'User research'      },
...
const projects = {
  ...
  resourcecentral: {
    ...
    sections: [
      ...
      {
        label:   'The Solution',
        content: `A clean, search-first dashboard with <strong>category filters, bookmarks, and a Quick Links tray</strong>. Usability testing showed a 40% reduction in time-to-resource compared to the existing portals.`,
      },
    ],
  },
  ...
  const slidesHTML = slides.map(s => `
    <div class="carousel-slide">
      <div class="carousel-slide-inner">
        <div class="slide-placeholder" style="background:${s.bg}"></div>
      </div>
    </div>`).join('');
